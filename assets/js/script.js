...
document.getElementById('product-Bedsheet').addEventListener('click', () => {
  ...
  <table class="table table-bordered table-striped">
    ...
    <tbody>
      ...
      <tr>
        <td>Dry wash + Iron <br> Rs.42</td>
        <td style="text-align: center;">
          <input type="text" class="mx-auto quantity form-control" data-price="42" placeholder="0" min="0" maxlength="3" style="width: 50px;">
        </td>
        <td class="row-total" style="white-space: nowrap; text-align: right;">0</td>
      </tr>
      <tr>
        <td>Iron<br> Rs.20</td>
        <td style="text-align: center;">
          <input type="text" class="mx-auto quantity form-control" data-price="20" placeholder="0" min="0" maxlength="3" style="width: 50px;">
        </td>
        <td class="row-total" style="white-space: nowrap; text-align: right;">0</td>
      </tr>
    </tbody>
...
document.getElementById('product-Carpet').addEventListener('click', () => {
  ...
  <table class="table table-bordered table-striped">
   ...
   <tbody>
      <tr>
        <td>Wash & Fold <br> Rs.60</td>
        <td style="text-align: center;">
          <input type="text" class="mx-auto quantity form-control" data-price="60" placeholder="0" min="0" maxlength="3" style="width: 50px;">
        </td>
        <td class="row-total" style="white-space: nowrap; text-align: right;">0</td>
      </tr>
    </tbody>
...
document.getElementById('product-CurtainPanel').addEventListener('click', () => {
  ...
  <table class="table table-bordered table-striped">
   ...
   <tbody>
      <tr>
        <td>Wash & Fold <br> Rs.40</td>
        <td style="text-align: center;">
          <input type="text" class="mx-auto quantity form-control" data-price="40" placeholder="0" min="0" maxlength="3" style="width: 50px;">
        </td>
        <td class="row-total" style="white-space: nowrap; text-align: right;">0</td>
      </tr>
      <tr>
        <td>Dry wash + Iron <br> Rs.52</td>
        <td style="text-align: center;">
          <input type="text" class="mx-auto quantity form-control" data-price="52" placeholder="0" min="0" maxlength="3" style="width: 50px;">
        </td>
        <td class="row-total" style="white-space: nowrap; text-align: right;">0</td>
      </tr>
      <tr>
...
document.getElementById('product-Mat').addEventListener('click', () => {
  ...
  <table class="table table-bordered table-striped">
    ...
    <tbody>
      <tr>
        <td>Wash & Fold <br> Rs.22</td>
        <td style="text-align: center;">
          <input type="text" class="mx-auto quantity form-control" data-price="22" placeholder="0" min="0" maxlength="3" style="width: 50px;">
        </td>
        <td class="row-total" style="white-space: nowrap; text-align: right;">0</td>
      </tr>
      <tr>
        <td>Dry wash + Iron <br> Rs.40</td>
        <td style="text-align: center;">
          <input type="text" class="mx-auto quantity form-control" data-price="40" placeholder="0" min="0" maxlength="3" style="width: 50px;">
        </td>
        <td class="row-total" style="white-space: nowrap; text-align: right;">0</td>
...
document.getElementById('product-Pillow').addEventListener('click', () => {
  ...
  <tbody>
      <tr>
        <td>Wash & Fold <br> Rs.15</td>
        <td style="text-align: center;">
          <input type="text" class="mx-auto quantity form-control" data-price="15" placeholder="0" min="0" maxlength="3" style="width: 50px;">
        </td>
        <td class="row-total" style="white-space: nowrap; text-align: right;">0</td>
      </tr>
      <tr>
        <td>Dry wash + Iron <br> Rs.20</td>
        <td style="text-align: center;">
          <input type="text" class="mx-auto quantity form-control" data-price="20" placeholder="0" min="0" maxlength="3" style="width: 50px;">
        </td>
        <td class="row-total" style="white-space: nowrap; text-align: right;">0</td>
      ...
      <tr>
        <td>Iron<br> Rs.6</td>
        <td style="text-align: center;">
          <input type="text" class="mx-auto quantity form-control" data-price="6" placeholder="0" min="0" maxlength="3" style="width: 50px;">
        </td>
        <td class="row-total" style="white-space: nowrap; text-align: right;">0</td>
      </tr>
    </tbody>
...
<tbody>
      <tr>
        <td>Wash & Fold <br> Rs.10</td>
        <td style="text-align: center;">
          <input type="text" class="mx-auto quantity form-control" data-price="10" placeholder="0" min="0" maxlength="3" style="width: 50px;">
        </td>
        <td class="row-total" style="white-space: nowrap; text-align: right;">0</td>
      </tr>
      <tr>
        <td>Dry wash + Iron <br> Rs.17</td>
        <td style="text-align: center;">
          <input type="text" class="mx-auto quantity form-control" data-price="17" placeholder="0" min="0" maxlength="3" style="width: 50px;">
        </td>
        <td class="row-total" style="white-space: nowrap; text-align: right;">0</td>
